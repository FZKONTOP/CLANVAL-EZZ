--[[
    ╔══════════════════════════════════════════════════════════╗
    ║                 Muscle Legends Companion                 ║
    ║                    Version: 4.0.0                        ║
    ║                 Developed by: MyersDev                   ║
    ║      All rights reserved © 2024 - Professional Edition    ║
    ╚══════════════════════════════════════════════════════════╝
]]
...
local library = loadstring(game:HttpGet("https://codeberg.org/Havoc-User/UI/raw/branch/main/LIB.20", true))()

local player = game.Players.LocalPlayer
local displayName = player.DisplayName or player.Name

local window = library:AddWindow("❤️Private Kill Artemisa26 ❤️ BY CRAKED KARMA | Hello " .. displayName, {
    main_color = Color3.fromRGB(90, 0, 160),
...
local petSwitch = Killer:AddSwitch("Auto Remplazar Pets💱", function(state)
...
-- Pet Selection
Killer:AddLabel("Selección daño o durabilidad pet").TextSize = 18
...
Killer:AddSwitch("Auto Lista Blanca Amigos", function(state)
...
local spyTargetDropdown = Killer:AddDropdown("Select Ver objetivo 👁️", function(displayName)
    for _, player in ipairs(Players:GetPlayers()) do
        if player.DisplayName == displayName then
...
Killer:AddButton("Remover animación de puño", function()
...
Killer:AddButton("Devolver animación de puño", function()
    RecoveryPunch()
end)
...
Killer:AddSwitch("Auto Puño [Sin animación]", function(state)
...
Killer:AddSwitch("Puño rápido", function(state)
...
Killer:AddSwitch("Auto GODMODE Join Tiny island", function(state)
    ...
    if state then
        warn("🔄 Auto Area Travel ATIVADO - Tentando viajar para área...")
        task.spawn(function()
            ...
            if success then
                warn("✅ Viagem de área executada com sucesso!")
                ...
                warn("❌ Erro ao viajar para área:", result)
                StarterGui:SetCore("SendNotification", {
                    Title = "Area Travel",
        ...
        warn("⛔ Auto Area Travel DESATIVADO")
    end
end)
...
task.spawn(function()
    while true do
        if autoAreaTravelEnabled then
            ...
            if success then
                warn("🔄 Tentativa de viagem automática realizada")
            end
        else
            task.wait(1)
        end
...
Killer:AddButton("GODMODE Tiny island (Button)", function()
    ...
    if success then
        warn("✅ Viagem manual executada com sucesso!")
        StarterGui:SetCore("SendNotification", {
            Title = "Area Travel",
        ...
        warn("❌ Erro na viagem manual:", result)
    end
end)
...
-- Size NaN Button
Killer:AddButton("Tamaño mínimo", function()
    ReplicatedStorage.rEvents.changeSpeedSizeRemote:InvokeServer("changeSize", 0/0)
end)

-- Dead Hit Activation
Killer:AddButton("Activación pegar muerto 🥀", function()
...
local switch = Misc:AddSwitch("Posición bloqueada 🚫", function(Value)
    if Value then
...
Misc:AddSwitch("Anti Rechazo", function(Value)
    if Value then
...
local timeDropdown = Misc:AddDropdown("Change Time", function(selection)
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "